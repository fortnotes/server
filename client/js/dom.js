...
app.dom = (function(){
	 ...
	 *		TODO: add
	 */
	module.tag = function ( tagName, attrList, content ) {
		// prepare
		var index,
	 ...
	 */
	module.fragment = function ( content ) {
		// prepare placeholder
	 ...
	 */
	module.add = function ( tagDst, content ) {
		// prepare
		var index;
